...
public class Molecule implements Serializable{
	...
	public void appendResidue(){
	
	}
	
	public void prependResidue(){
    ...
    public int[] getResiduePhiDihedralAtoms(int residueNumber)
    {
    	int startNumber = residue[residueNumber].getAtomNameToMolnum("H3"); 
    	if(residueNumber < 1) return new int[]{-1};
    	return new int[]{residue[residueNumber-1].getAtomNameToMolnum("C"), residue[residueNumber].getAtomNameToMolnum("N"),
    			residue[residueNumber].getAtomNameToMolnum("CA"), residue[residueNumber].getAtomNameToMolnum("C")
    			};
    }

    public int[] getResiduePsiDihedralAtoms(int residueNumber)
    {
    	int endNumber = residue[residueNumber].getAtomNameToMolnum("O");
    	if(residueNumber +1 < residue.length) endNumber = residue[residueNumber+1].getAtomNameToMolnum("N");
    	return new int[]{residue[residueNumber].getAtomNameToMolnum("N"), residue[residueNumber].getAtomNameToMolnum("CA"),
    			residue[residueNumber].getAtomNameToMolnum("C"), endNumber
    			};
    }
