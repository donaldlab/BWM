                ...
                //This is needed when the end of a Lys or Arg sidechain is disordered, etc.
                    ...
                    if( ! isTemplAA ){//Can't mutate a non-AA residue
                        ...
                        for( Atom at : templ.atom ){
                            if( at.isBBatom ){
                            	System.out.println("Verifying presence of backbone atom "+at.name+" for template "+res.fullName);
                                if( res.getAtomByName( at.name ) == null ){
                                    mutPossible = false;
                                    System.out.println("Error: cannot find atom "+at.name+" for residue "+res.fullName);
                                    break;
                                }
                            }
                        }
